...
<main id='about_main' className={`home_main${ThemeValue?"darkMode":""} `}>
  
<div className={`w-full h-auto bg-[#EEEEEE] ${ThemeValue?"darkMode":""}`}>
...
<section className={`sec_team w-full h-auto ${ThemeValue?"darkMode":""}`}>
