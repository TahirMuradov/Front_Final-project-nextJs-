...
<main id='about_main' className={`home_main${themeState=="dark"?"darkMode":""} `}>
...
<section className="sec_about1 w-[100%] h-[80vh] relative">
...
<section className='sec_team w-full h-auto'>
  <div className="w-4/5 m-auto">
    ...
    <div className="row_user flex  flex-wrap">
      <div className="user_box w-[33.33%]">

      <div className="img-box w-[full] h-[479px] px-1"><Image src={user1} /></div>
...
<div className="img-box w-[full] h-[full] px-1"><Image src={user2} /></div>
<div className="content">
<h3>Christian Gregory</h3>
  <p>CEO - Founder</p>
</div>
...
<div className="img-box w-[full] h-[full] px-1"><Image src={user3} /></div>
<div className="content">
<h3>Christian Gregory</h3>
  <p>CEO - Founder</p>
</div>
...
<div className="img-box w-[250px] h-[479] px-1"><Image src={user4} className='w-full'/></div>
<div className="content">
<h3>Christian Gregory</h3>
  <p>CEO - Founder</p>
</div>
